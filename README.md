...
![Network Risk Map](results/Risk assessment.jpg)
...
| Communication Range | 8 units |
| K-Means Clusters | 10 |
| DoS-Affected Nodes | 10% |
| Node Failure | 5% |
| Targeted Cluster Heads | 3 |
...
1. Fog node deployment
2. Communication graph construction
3. K-Means clustering
4. LEACH cluster-head selection
5. Degree-based cluster-head selection
6. Energy-based cluster-head selection
7. Cyberattack injection
8. QoS evaluation
9. Risk calculation
10. High-risk node identification
11. Risk-map visualization
...
6. The simulation will generate the network, clustering, attack, QoS, and risk visualizations.
